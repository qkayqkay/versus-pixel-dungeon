...
public class WndRespawn extends Window {
	...
	public WndRespawn(final Ankh ankh ) {
			...
			protected void onClick() {
				if (btnItem1.item() == null || btnItem2.item() == null){
					GameScene.show(new WndOptions(Icons.WARNING.get(),
							Messages.get(WndRespawn.class, "warn_title"),
							Messages.get(WndRespawn.class, "warn_body"),
							Messages.get(WndRespawn.class, "warn_yes"),
							Messages.get(WndRespawn.class, "warn_no")){
						@Override
	...
	protected WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public String textPrompt() {
			return Messages.get(WndRespawn.class, "prompt");
		}
